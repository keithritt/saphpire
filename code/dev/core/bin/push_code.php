...
if(getcwd() != '/home3/oloop/public_html/saphpire/code/dev/core/bin')
  die('script can only be run from: /home3/oloop/public_html/saphpire/code/dev/core/bin');
...
//print 'asdf';
//die();
require_once(SAPHPIRE_PATH.'/code/'.CODE_ENV.'/core/autoload.php');
