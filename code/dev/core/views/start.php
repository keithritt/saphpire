...
if(isset($this->sHeadIntro))
  $sHtml.= $this->sHeadIntro;
  ...
  {
    oNs.record_js_error(sMsg, sUrl, iLine);
  }
  var oNs = {};
...
unset(Controller::$aRegions['head_start']);
